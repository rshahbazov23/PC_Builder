...
-- Additional categories (cooler/monitor/keyboard/mouse/headset) products
-- Note: These are appended after the original 182 products so existing product_id references remain valid.
